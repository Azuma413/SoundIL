...
class SoundController:
    def __init__(self):
        ...
        self.left_volume = 50     # 初期値は50%
        self.right_volume = 50    # 初期値は50%
    ...
    def generate_gaussian_noise(self, duration):
        ...
        samples = np.random.normal(0, 0.1, int(self.sample_rate * duration))
    ...
    def set_volume(self, left=None, right=None):
        ...
        if sink_list:
            ...
            # チャンネルマップを取得
            channel_map = default_sink.channel_map
    ...
    def play_noise(self, duration=5.0):
        ...
        print(f"ガウスノイズを再生します（{duration}秒）")
...
def main():
    ...
    try:
        # 音量設定
        controller.set_volume(args.left, args.right)
